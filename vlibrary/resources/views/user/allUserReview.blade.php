...
<body>
	...
	<li  class='last'> <a href="auth/logout">Log Out </a> </li>
 	...
 	<h1 align="center">All User Reviews</h1>
	  <ul class="list-group" style="width: 50%" align="center"> 		

			@for($i = 0; $i < count($name) -1; $i++)
			  <li class="list-group-item">
			  		UserName is: <b>{{$name[$i][0]}}</b> and rating is: 
			  		<div align="right"><b>{{$name[$i][1]}}</b></div>
		...
		<h4>All Review User list over</h4>
